...
const TicketDetails = async (props: { params: Promise<{ id: string }> }) => {
    ...
    <div className="min-h-screen bg-blue-50 p-8">
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow border border-gray-200 p-8 space-y-6">
            ...
            <div className='text-gray-700'>
                ...
                <time dateTime={new Date(ticket.createdAt).toLocaleString()}>
                    {new Date(ticket.createdAt).toLocaleString()}
                </time>
            </div>

            <Link href='/tickets' className='inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition'>
                ← Back to Tickets
            </Link>
